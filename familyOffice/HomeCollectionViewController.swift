...
class HomeCollectionViewController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    var btnsArray = [homesBtn(#imageLiteral(resourceName: "Calendar"), #colorLiteral(red: 0.9254902005, green: 0.2352941185, blue: 0.1019607857, alpha: 1),"calendarSegue"), homesBtn(#imageLiteral(resourceName: "chat"), #colorLiteral(red: 0.2392156869, green: 0.6745098233, blue: 0.9686274529, alpha: 1), "chatSegue"), homesBtn(#imageLiteral(resourceName: "safeBox"), #colorLiteral(red: 0.9529411793, green: 0.6862745285, blue: 0.1333333403, alpha: 1), "safeBoxSegue"), homesBtn(#imageLiteral(resourceName: "insurance"),#colorLiteral(red: 0.3411764801, green: 0.6235294342, blue: 0.1686274558, alpha: 1),""), homesBtn(#imageLiteral(resourceName: "FirstKit"), #colorLiteral(red: 0.1764705926, green: 0.01176470611, blue: 0.5607843399, alpha: 1),"firstAidKitSegue"), homesBtn(#imageLiteral(resourceName: "safebox-all-files"), #colorLiteral(red: 0.07450980392, green: 0.3215686275, blue: 0.2039215686, alpha: 1), "insuranceSegue")]

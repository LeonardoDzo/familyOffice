...
class HomeCollectionViewController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    var btnsArray = [homesBtn(#imageLiteral(resourceName: "Calendar"), #colorLiteral(red: 1, green: 0.2901960784, blue: 0.3529411765, alpha: 1),"calendarSegue"), homesBtn(#imageLiteral(resourceName: "chat"), #colorLiteral(red: 0.01568627451, green: 0.7019607843, blue: 0.9960784314, alpha: 1), "chatSegue"), homesBtn(#imageLiteral(resourceName: "safeBox"), #colorLiteral(red: 0.9607843137, green: 0.7215686275, blue: 0.1176470588, alpha: 1), "safeBoxSegue"), homesBtn(#imageLiteral(resourceName: "insurance"),#colorLiteral(red: 0.1137254902, green: 0.7176470588, blue: 0.4352941176, alpha: 1),"insuranceSegue"), homesBtn(#imageLiteral(resourceName: "FirstKit"), #colorLiteral(red: 0.5490196078, green: 0.5294117647, blue: 0.7843137255, alpha: 1),"firstAidKitSegue")]
